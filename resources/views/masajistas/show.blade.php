    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="card p-6 mb-6">
            <div class="flex items-start gap-4">
                <div class="w-14 h-14 rounded-full bg-purple-100 flex items-center justify-center text-purple-700 font-bold text-lg shrink-0">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-8 text-sm">
                        ...
                        <div>
                            <span class="text-gray-500">Comisión general:</span>
                            <span class="font-medium text-gray-900 ml-1">{{ rtrim(rtrim(number_format($masajista->porcentaje_comision, 2), '0'), '.') }}%</span>
                        </div>
                        @php
                        ...
                        @endphp
                        <div>
                            <span class="text-gray-500">Comisión total:</span>
                            <span class="font-bold text-primary-700 ml-1">${{ number_format($totalComision, 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card p-6 mb-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Servicios y Comisiones</h2>
