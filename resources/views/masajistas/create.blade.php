...
@section('contenido')
    <div class="bg-surface-50 min-h-[calc(100vh-4rem)]" id="masajistas-create-page">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">

            {{-- Header --}}
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Nuevo Masajista</h1>
                ...
                <form action="{{ route('masajistas.store') }}" method="POST">
                    ...
                    <div class="p-6 sm:p-8 space-y-6">
                        <div>
                            ...
                            <input type="text" id="cedula" name="cedula" value="{{ old('cedula') }}" class="input-field">
                            @error('cedula')
                        ...
                        <div>
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" class="input-field">
                            @error('nombre')
                                <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
                                @foreach ($servicios as $servicio)
                                    <div
                                        class="relative flex items-start p-3 border border-gray-200 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
                        ...
                        <div>
                            ...
                            <input type="number" id="porcentaje_comision" name="porcentaje_comision"
                                value="{{ old('porcentaje_comision') }}" class="input-field">
