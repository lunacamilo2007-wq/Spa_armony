            ...
            <form action="{{ route('servicios.store') }}" method="POST">
                ...
                <div class="p-6 sm:p-8 space-y-6">
                    <div>
                        ...
                        <input type="text" id="nombre_servicio" name="nombre_servicio" value="{{ old('nombre_servicio') }}" class="input-field">
                    ...
                    <div>
                        ...
                        <input type="text" id="descripcion" name="descripcion" value="{{ old('descripcion') }}" class="input-field">
                        @error('descripcion')
                            <span class="text-sm text-red-600 mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
