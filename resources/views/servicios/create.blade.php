...
<div class="bg-surface-50 dark:bg-surface-900 min-h-[calc(100vh-4rem)]">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-gradient-to-r from-primary-500 to-primary-700 rounded-2xl p-8 mb-8 relative overflow-hidden">
            ...
            <h1 class="text-2xl font-bold text-white relative z-10">Nuevo Servicio</h1>
            <p class="text-primary-100 mt-1 relative z-10">Agrega un nuevo servicio al catálogo</p>
        </div>
            ...
            <div class="card p-6 mb-6">
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="nombre_servicio" name="nombre_servicio" value="{{ old('nombre_servicio') }}" class="input-field" placeholder="Ej: Masaje relajante" required>
                    ...
                    <div>
                        ...
                        <input type="number" id="precio" name="precio" value="{{ old('precio') }}" class="input-field" placeholder="50000" min="0" required>
                        @error('precio')
                            <span class="text-sm text-red-600 mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="descripcion" name="descripcion" rows="3" class="input-field" placeholder="Descripción del servicio...">{{ old('descripcion') }}</textarea>
                        @error('descripcion')
                            <span class="text-sm text-red-600 mt-1">{{ $message }}</span>
                        @enderror
                    </div>
