                ...
                <div class="p-6 sm:p-8 space-y-10">
                        ...
                        <div>
                            ...
                            <div class="flex gap-4 mb-6">
                                <label class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none transition-all"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5 text-primary-600" x-show="esNuevoCliente === '0'"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/></svg>
                                </label>
                                ...
                                <label class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none transition-all"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5 text-primary-600" x-show="esNuevoCliente === '1'" style="display: none;"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/></svg>
                                </label>
                            </div>
                            ...
                            <div x-show="esNuevoCliente === '1'" x-transition x-cloak class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2 p-5 bg-gray-50 border border-gray-200 rounded-xl">
                                <div>
                                    <label for="nuevo_cliente_cedula" class="label-field">Cédula <span class="text-red-500">*</span></label>
                                    <input type="number" name="nuevo_cliente_cedula" id="nuevo_cliente_cedula" value="{{ old('nuevo_cliente_cedula') }}"
                                        class="input-field">
                                </div>

                                <div>
                                    <label for="nuevo_cliente_nombre" class="label-field">Nombre Completo <span class="text-red-500">*</span></label>
                                    <input type="text" name="nuevo_cliente_nombre" id="nuevo_cliente_nombre" value="{{ old('nuevo_cliente_nombre') }}"
                                        class="input-field">
                                </div>

                                <div>
                                    <label for="nuevo_cliente_telefono" class="label-field">Teléfono <span class="text-red-500">*</span></label>
                                    <input type="text" name="nuevo_cliente_telefono" id="nuevo_cliente_telefono" value="{{ old('nuevo_cliente_telefono') }}"
                                        class="input-field">
                                </div>

                                <div>
                                    <label for="nuevo_cliente_correo" class="label-field">Correo Electrónico <span class="text-red-500">*</span></label>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            ...
                            {{-- Fecha y Hora --}}
                            <div>
                                <label for="fecha" class="label-field">Fecha y Hora <span class="text-red-500">*</span></label>
                            ...
                            {{-- Habitación --}}
                            <div>
                                <label for="habitacion" class="label-field">Habitación N° <span class="text-red-500">*</span></label>
                            ...
                            <div class="sm:col-span-2">
                                <label for="masajista" class="label-field">Masajista Asignado <span class="text-red-500">*</span></label>
